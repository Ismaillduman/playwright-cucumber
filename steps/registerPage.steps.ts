...
When('user should be able to navi to {string}',async function (string) {
  ...
  When('user enter {string} {string} {string} and {string}',async function (string, string2, string3, phone_number:string) {
    const registerPage= new RegisterPage(page);
  ...
  When('user enter the {string} and {string}',async function (password:string, confirm_password:string) {
    const registerPage= new RegisterPage(page);
  ...
  When('the user confirm that  is over {int} years old and and completes the registration',async function (int) {
    const registerPage= new RegisterPage(page);
 await registerPage.confirmAge();
  ...
  Then('the user sees the message registration completed successfully',async function () {
    const registerPage= new RegisterPage(page);

...
export class PasswordForgotPage{
    ...
    constructor(page:Page){
        ...
        this.passwordChangeMessage=page.locator('[aria-label="Password Changed Successfully"]');
    ...
    async enterCredentials(email:string, password:string,confirmPasword:string){
